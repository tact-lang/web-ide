...
import { JettonSandboxTest, TactJettonMaster } from './template/tact/jetton';
import { AmmSandboxTest, TactAmmPool } from './template/tact/amm';
  ...
  tonJetton: {
    ...
    tact: [
      ...
      },
      {
        ...
        parent: '3',
        type: 'file' as const,
        path: 'tests/jetton.spec.ts',
        content: JettonSandboxTest,
      },
    ],
  },
  tonAmm: {
    ...
    tact: [
      ...
      },
      {
        ...
        parent: '1',
        type: 'file' as const,
        path: 'contracts/pool.tact',
        content: TactAmmPool.code,
      },
      {
        id: '3',
        name: 'tests',
      ...
      },
      {
        ...
        parent: '3',
        type: 'file' as const,
        path: 'tests/amm.spec.ts',
        content: AmmSandboxTest,
      },
    ],
  },
};
